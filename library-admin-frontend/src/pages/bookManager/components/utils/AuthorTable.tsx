...
export const AuthorTable: React.FC<{ authors: AuthorModel[]; handleDeleteAuthors: any; openAuthorEdit?: any }> = (
    props,
) => {
            ...
            getActions: ({ id, row }) => {
                ...
                return [
                    <GridActionsCellItem
                        ...
                        className="textPrimary"
                        color="inherit"
                        onClick={(event: React.SyntheticEvent) => props.openAuthorEdit(event, row.id)}
                    />,
