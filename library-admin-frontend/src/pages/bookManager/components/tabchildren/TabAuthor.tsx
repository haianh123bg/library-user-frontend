    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            <CustomTabPanel value={value} index={0}>
                <Box sx={{ display: 'flex', gap: '16px' }}>
                    {isLoadingAuthors ? (
                        ...
                        <AuthorTable
                            handleDeleteAuthors={handleDeleteAuthors}
                            authors={authors}
            ...
            <CustomTabPanel value={value} index={1}>
                <AuthorFormAdd handleClick={handleClick} handleTrigger={handleTrigger} />
            </CustomTabPanel>
            <CustomTabPanel value={value} index={2}>
                <AuthorFormAdd handleClick={handleClick} handleTrigger={handleTrigger} author={author} />
            </CustomTabPanel>
